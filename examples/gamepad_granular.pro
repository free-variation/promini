...
demo(Source) :-
    ...
    granular_set_mode(G, [0, 3, 5, 7, 10], 0, 5),  /* D minor pentatonic, 1 octave up */
    ...
    maplist(mod_route_monitor, [R1,R2,R3,R4,R5,R6,R7,R8,R9,R10,R11,R12,R13,R14,R15,R16,R17,R18,R19,R20],
