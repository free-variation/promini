...
demo :-
    ...
    %capture_start('BlackHole 2ch', 10.0, Capture, _),
    capture_start('iPad', 10.0, Capture, _),
    granular_init(4.0, G),
    ...
    /* Analog routes */
    mod_route_init(LX, granular, G, density, rate, 10.0, 0.0, 0.0, _),
    mod_route_init(LY, granular, G, size, rate, -100.0, 0.0, 0.0, _),
    mod_route_init(RX, granular, G, position, rate, 0.5, 0.0, 0.0, _),
    mod_route_init(RY, granular, G, position_spray, rate, -0.3, 0.0, 0.0, _),
    mod_route_init(LT, granular, G, pitch, absolute, -12.0, 0.0, 0.0, _),
    mod_route_init(RT, granular, G, pitch, absolute, 12.0, 0.0, 0.0, _),

    /* Button routes */
    mod_route_init(LB, granular, G, envelope, absolute, 1.0, 0.0, 0.0, _),
    mod_route_init(RB, granular, G, reverse, absolute, 1.0, 0.0, 0.0, _),
    mod_route_init(YBtn, granular, G, regularity, absolute, 1.0, 0.0, 0.0, _),
    mod_route_init(ABtn, granular, G, trigger, absolute, 1.0, 0.0, 0.0, _),
    mod_route_init(L3Btn, granular, G, trigger, absolute, 1.0, 0.0, 0.0, _),
    mod_route_init(R3Btn, granular, G, reset, absolute, 1.0, 0.0, 0.0, _),
    mod_route_init(BBtn, granular, G, reverse, absolute, 1.0, 0.0, 0.0, _),
    mod_route_init(XBtn, granular, G, recording, absolute, -1.0, 1.0, 0.0, _),
    mod_route_init(PLBtn, reverb, Rev, freeze, absolute, 1.0, 0.0, 0.0, _),

    /* D-pad: reverb wet/decay increment/decrement */
    mod_route_init(DUp, reverb, Rev, decay, rate, 0.3, 0.0, 0.0, _),
    mod_route_init(DDown, reverb, Rev, decay, rate, -0.3, 0.0, 0.0, _),
    mod_route_init(DRight, reverb, Rev, wet, rate, 0.3, 0.0, 0.0, _),
    mod_route_init(DLeft, reverb, Rev, wet, rate, -0.3, 0.0, 0.0, _),
