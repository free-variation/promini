...
demo_envelope :-
    ...
    mod_route_create(Env, oscillator, Osc, frequency, absolute, 200.0, 440.0, 0.0, Route),
...
demo_looping_envelope :-
    ...
    mod_route_create(Env, oscillator, Osc, frequency, absolute, 50.0, 330.0, 0.0, Route),
...
demo_dual_envelope :-
    ...
    mod_route_create(Env1, oscillator, Osc1, frequency, absolute, 100.0, 220.0, 0.0, Route1),
    mod_route_create(Env2, oscillator, Osc2, frequency, absolute, 150.0, 330.0, 0.0, Route2),
...
demo_tremolo :-
    ...
    mod_route_create(Lfo, oscillator, Osc, volume, absolute, 0.3, 0.5, 0.0, Route),
...
demo_amp_envelope :-
    ...
    mod_route_create(Env, oscillator, Osc, volume, absolute, 1.0, 0.0, 0.0, Route),
...
demo_guitar_tremolo :-
    ...
    mod_route_create(Lfo, sound, Sound, volume, absolute, 0.4, 0.5, 0.0, Route),
...
demo_guitar_swell :-
    ...
    mod_route_create(Env, sound, Sound, volume, absolute, 1.0, 0.0, 0.0, Route),
...
demo_auto_pan :-
    ...
    mod_route_create(Lfo, pan, PanPtr, pan, absolute, 1.0, 0.0, 0.0, Route),
