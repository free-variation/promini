...
# Source and output
SRC := src/c/promini.c src/c/synth.c src/c/effects.c src/c/init.c src/c/reverb.c src/c/mod.c src/c/mixer.c src/c/image.c src/c/control.c src/c/capture.c src/c/granular.c src/c/clock.c src/c/visualizer.c
